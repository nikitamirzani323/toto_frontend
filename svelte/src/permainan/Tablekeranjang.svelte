            ...
            >
                ...
                <tr>
                    <td style="color:white;"
                        >4D : <span style="color:#f7941d;">{count_line_4d}</span
                        ></td
                    >
                    <td style="color:white;"
                        >3D : <span style="color:#f7941d;">{count_line_3d}</span
                        ></td
                    >
                    <td style="color:white;"
                        >2D : <span style="color:#f7941d;">{count_line_2d}</span
                        ></td
                    >
                    <td style="color:white;"
                        >2D DEPAN : <span style="color:#f7941d;"
                            >{count_line_2dd}</span
                        ></td
                    >
                    <td style="color:white;"
                        >2D TENGAH : <span style="color:#f7941d;"
                            >{count_line_2dt}</span
                        ></td
                    >
                </tr>
        ...
        {:else}
            ...
            >
                ...
                <tr>
                    ...
                    >
                    <td style="color:white;"
                        >2DD : <span style="color:#f7941d;"
                            >{count_line_2dd}</span
                        ></td
                    >
                    <td style="color:white;"
                        >2DT : <span style="color:#f7941d;"
                            >{count_line_2dt}</span
                        ></td
                    >
                </tr>
...
<Modal modal_id={"modalInformasi"} modal_size={"modal-lg"}>
    <slot:template slot="header">
        <div class="float-end">
            <img
                style="cursor:pointer;"
        ...
        <h5 class="modal-title" id="exampleModalLabel">4D, 3D dan 2D</h5>
    </slot:template>
    <slot:template slot="body">
        <TabContent style="padding: 0px;margin:0px;">
            <TabPane
                tabId="informasi_432d"
                tab="INFORMASI"
                active
            ...
            >
                ...
                <p style="font-size:12px;padding:5px;color:white;">
                    ...
                    1234 : 4D, 123 : 3D, 12 : 2D, <br />
                    **12 : 2D, 12** : 2DD, *12* : 2DT
                </p>
            </TabPane>
            <TabPane
                tabId="carabermain_432d"
                tab="CARA BERMAIN"
                style="padding:0px;font-size:12px;color:#8a8a8a;"
            >
                <p style="padding: 5px;">
